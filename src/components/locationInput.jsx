    ...
    return (
        <div className="InputContainer">
            <div className="input-group mb-3" id="InputGroup">
                <input type="text" className="form-control" placeholder="Enter your location" aria-label="Recipient's username" aria-describedby="button-addon2" onChange={props.change} />
